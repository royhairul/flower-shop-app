...
<title>Toko Bunga Lokal</title> <script src="https://cdn.tailwindcss.com"></script> </head>
  ...
  <body> <nav class="bg-gray-800">
    ...
    <form class="p-10" action="{{ route('admin.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="space-y-12">
        <div class="border-b border-gray-900/10 pb-12">
          <h2 class="text-lg font-bold leading-7 text-gray-900">Membuat Data Baru</h2>
          <p class="mt-1 text-sm leading-6 text-gray-600">Menambahkan data barang untuk Toko</p>
          ...
          <div class="mt-10 grid gap-x-6 gap-y-8">
            ...
            <div class="sm:col-span-1">
              ...
              <div class="mt-2">
                <input type="text" name="price" id="price" autocomplete="given-name"
                  class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6  p-2">
              </div>
            </div>
            <div class="sm:col-span-1">
              ...
              <div class="mt-2">
                <input type="number" name="stock" id="stock" autocomplete="given-name"
                  class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6  p-2">
              </div>
            </div>
