        ...
        <header class="absolute inset-x-0 top-0 z-50">
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div class="hidden lg:flex lg:gap-x-12">
                    ...
                    <a href="/produk" class="text-sm font-semibold leading-6 text-gray-900">Produk Kami</a>
                </div>
            ...
            <div class="mx-auto max-w-2xl py-24 sm:py-40 lg:py-48">
                <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                    <div
                        ...
                        Kami memiliki jenis bunga baru. <a href="#" class="font-semibold text-indigo-600"><span
